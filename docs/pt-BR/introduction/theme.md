...
A biblioteca ainda não possui nenhum tema além do padrão. No entanto, é possível personalizar o tema criando seu próprio arquivo como no exemplo a seguir:
